...
class TbTaskSuite(models.Model):
...
class TbTaskSuiteExecute(models.Model):
    ...
    taskExecuteIdList = models.TextField(db_column="taskExecuteIdList",verbose_name="本次任务执行包含的任务执行Id",default="")
