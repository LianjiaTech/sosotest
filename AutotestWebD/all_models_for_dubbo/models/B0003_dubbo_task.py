...
class Tb2DubboTaskExecute(models.Model):
    ...
    execBy = models.ForeignKey(to=TbUser, to_field="loginName", related_name="Tb2DubboTaskExecuteExecBy",db_column='execBy', max_length=30, blank=True, default="", verbose_name="执行人登录用户名")
...
class Tb2DubboInterfaceExecuteHistory(models.Model):
    ...
    taskExecuteId = models.ForeignKey(to=Tb2DubboTaskExecute,related_name="Tb2DubboInterfaceExecuteHistoryTaskExecuteId",db_column='taskExecuteId', verbose_name="任务执行表的主键ID，关联哪次执行的任务")
    ...
    execBy = models.ForeignKey(to=TbUser,to_field="loginName",related_name="Tb2DubboInterfaceExecuteHistoryExecBy",db_column='execBy', max_length=30, blank=True, default="", verbose_name="执行人登录用户名")
