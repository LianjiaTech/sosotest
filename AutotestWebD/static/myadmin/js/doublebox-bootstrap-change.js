(function ($, window, document, undefined) {
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            this.container = $("" + '<div class="bootstrap-duallistbox-container">' + ' <div class="box1">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + "   </span>" + '   <input class="filter form-control ue-form" type="text">' + '   <select multiple="multiple" style="padding: 6px 0px;"></select>' + " </div>" + ' <div class="btn-box" style="margin-top: 75px" >' + '     <button type="button" class="btn db-btn move" style="width:100%;">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn moveall" style="width:100%;">' + "       <i></i>" + "       <i></i>" + "     </button>" + '     <p class="clearfix" style="margin-bottom:20px"></p>' + '     <button type="button" class="btn db-btn remove" style="width:100%;">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn removeall" style="width:100%;">' + "       <i></i>" + "       <i></i>" + "     </button>" + " </div>" + ' <div class="box2">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>'  + "   </span>" + '   <input class="filter form-control ue-form" type="text">' + '   <select multiple="multiple" style="padding: 6px 0px;"></select>' + " </div>"  + "</div>").insertBefore(this.element);
            this.elements = {
            ...
            if (options.nonSelectedList != null) {
                for (var i in options.nonSelectedList) {
                    if (options.nonSelectedList.hasOwnProperty(i)) {
                        items += "<option value='" + options.nonSelectedList[i][options.optionValue] + "' style='padding: 8px 10px;' style='padding: 8px 10px;' title='"+options.nonSelectedList[i][options.optionValue]+"' >" + options.nonSelectedList[i][options.optionText] + " </option>"
                    }
                }
            }
            if (options.selectedList != null) {
                for (var i in options.selectedList) {
                    if (options.selectedList.hasOwnProperty(i)) {
                        items += "<option value='" + options.selectedList[i][options.optionValue] + "' style='padding: 8px 10px;' title='"+options.selectedList[i][options.optionValue]+"'  selected>" + options.selectedList[i][options.optionText] + "</option>"
                    }
                }
            }
            box.append(items);
